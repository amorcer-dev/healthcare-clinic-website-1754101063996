  ...
  return (
    <main className="min-h-screen p-4 md:p-8">
      ...
      <WidgetProfile
        ...
        profileImage="https://res.cloudinary.com/drgqsqh1v/image/upload/v1754104723/amorcer/test/amorcer/test/Screenshot_2025-07-24_at_6.04.07_PM.png-1754104723061.png"
        className=""
      />
      <WidgetVideo
